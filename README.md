...
Десктопное приложение для мониторинга процессов, сетевых соединений, автозагрузки и базовой детекции подозрительной активности. Встроенный AI-ассистент на локальной SLM (без облака и без Ollama).
